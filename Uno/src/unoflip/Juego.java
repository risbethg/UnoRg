...
/*  importacion de las secciones a utilizar en este caso, son el lado oscuro y claro de las cartas*/
import unoflip.LightSide.*;
import unoflip.DarkSide.*;

/*  case juego donde se unen nustras partes del codigo  */
public class Juego {
    private int turno;
    private int ronda;
    private Mazo deck;
    ...
    /*  en esta cadena de caracteres se almacenan los jugadores
        cabe recalcar que el jeugo solo permite 4 jugadores    
        LA PERSONA QUE ESTA JUGANDO Y LOS OTROS 3 SON BOTS      */
    ...
    /*  si un jugador no tiene para jugar y le toca tobar una carta de la mesa */
    ...
    /*  cada que se tiere una carte y se elimine una de su mazo ademas, de el cambio de jugador */
    ...
    /*  valor booleano para validar la jugado con el lado calro de la carta*/
    ...
    /*  funcion que se usa al principio de cada partidas para darle las 7 cartas a cada jugador*/
    ...
    /*  metodo get pra la ronda*/
    public int getRonda(){
        return this.ronda;
    }
    
    /*  un entity para el jugador que se encuentra jugando ahora mismo  */
    public Entity jugadorActual(){
        return this.jugadores[this.turno];
    }
    
    /*  numero de cartas en pocision del jugar que esta jugando */
    public int nroCartasJugadorActual(){
        return this.jugadorActual().nroCartas();
    }
    
    /*  caplicado cada que se usa la carta que cambia el sentido de la partida  */
    ...
    /*  valor bolano para ser retornado en el caso de que termine nuestra partida*/
    public boolean finPartida(){
        return this.ganador() != null;
    }
    
    /*  el skip es para cuando alguien usa una carta y le hace saltar el turno al siguiente
        jugador                                                                             */
    public void skip(){
        this.cambiaTurno();
    }
    
    /*  usado para casa paso de turno, y asi saltar al siguiente participante   */
    ...
    /*  terira una de las cartas de nuestro mazo o indeck   */
    public Carta retirarCarta(){
        return deck.cartas[deck.inDeck--];
    }
    /*  para mostras las cartas en posecion */
